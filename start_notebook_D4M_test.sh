...
docker create -p 2222:22 -p 80:8888 -v ~/Documents/Kitematic/${CONTAINER_NAME}-notebooks/data/notebooks:/data/notebooks --name ${CONTAINER_NAME} jjpr/equation-to-object:latest
